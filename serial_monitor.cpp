...
// write cmd to motor controller
    ...
    void Roboteq::odom_stream()
    {
        ...
        // controller.write("/”d=”,”:”?F 1_?FM 1_?FS 1_?FF 1_# 20\r");
        controller.write("/”d=”,”:”?F 1_# 20\r");
    ...
    void Roboteq::odom_loop()
    {
        ...
        {
            std::string raw = controller.read(controller.available());
            std::cout << "[Serial RAW] " << raw << std::endl;
